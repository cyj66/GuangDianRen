<template>
  <div class="w2">
    ...
    <news-content :news-list="newsList"  v-if="this.$store.state.newsCollectList.length"></news-content>
  ...
  export default {
    ...
    data() {
      return {
        ...
        banners: [{
          info: "暨南大学官网",
          image: "https://news.jnu.edu.cn/UploadFiles/jnyw/2021/3/202103281703244993.jpg",
          link: "https://www.jnu.edu.cn/"
        }, {
          info: "理工学院官网",
          image: "https://lgxy.jnu.edu.cn/_upload/article/images/5d/72/5266b69c4188beca0615addaca79/1e480e55-022a-4d5c-9375-4c7ccadd39cd.png",
          link: "https://lgxy.jnu.edu.cn/"
        }, {
          info: "光电工程系官网",
          image: "https://gdgcx.jnu.edu.cn/_upload/article/images/85/ba/b5703308424d88552016343983bf/b4456d0e-384a-4651-a7a2-aee41d34569a.jpg",
          link: "https://gdgcx.jnu.edu.cn/main.htm"
        }]
      }
    },
    created() {
      getNewsData().then(res => this.newsList = res)
      getNewsCollectData().then(res => {
        ...
        this.$store.state.newsCollectList=newsCollectList
      })
    },
    mounted() {
